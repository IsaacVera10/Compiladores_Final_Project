...
public:
  ...
  virtual void visit(DoWhileStatement* e) = 0;  // Agregar visit para DoWhileStatement 
  virtual void visit(ForStatement* e) = 0;
  virtual void visit(BreakStatement* e) = 0; // Agregar visit para hacer typecheck a Break y Continue Statemtn
